...
#define GPIOCTL_IOC_RD_BUTTON		_IOR(GPIODRV_IOC_MAGIC, 1, long)
#define GPIOCTL_IOC_WR_LED_WHITE	_IOW(GPIODRV_IOC_MAGIC, 2, long)
#define GPIOCTL_IOC_WR_LED_RED		_IOW(GPIODRV_IOC_MAGIC, 3, long)
